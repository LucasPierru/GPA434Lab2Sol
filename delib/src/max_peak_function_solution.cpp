...
namespace de {
	...
	max_peak_function_solution::max_peak_function_solution()
	{
	...
	std::string de::max_peak_function_solution::to_string(de::agent const & ag) const
	{
	...
	double de::max_peak_function_solution::process(de::agent const & ag)
	{
